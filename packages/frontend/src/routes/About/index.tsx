...
function About() {
  return (
    <Flex flexDirection="column" align="center">
      ...
      <Text w="320px" mb="20px">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod officia
        explicabo quos recusandae consectetur. Laboriosam perspiciatis at fugit
        pariatur sint, ex nihil eius facilis earum modi quod labore, autem
        minus?
      </Text>
      <Box w="32" mb="20px">
        <img src={cohete}></img>
