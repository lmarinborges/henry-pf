    ...
    return (
        <Flex direction="column" alignItems="center"  minH={'100vh'} >
            ...
            <Flex justifyContent={'center'} alignItems={'baseline'} wrap='wrap'>
                <Box m='30px' boxSize={'400px'} display={'flex'} flexDir={'column'} alignItems='center' justifyContent={'center'} >
                    <Image
                        boxSize="150px"
                        objectFit="cover"
                        src={crossfit}
                ...
                <Box mx='30px'boxSize={'400px'} display={'flex'} flexDir={'column'} alignItems='center' justifyContent={'center'} >
                    <Image
                        boxSize="150px"
                        objectFit="cover"
                        src={pay}
